...
using TSE.Identidade.API.Extensions;
using TSE.Identidade.API.Models;

namespace TSE.Identidade.API.Controllers
{
    [ApiController]
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Login(UsuarioLogin usuarioLogin)
        {
            ...
            {
                AdicionarErroProcessamento("Usúario temporiamente bloqueado por tentativas inválidas");
                CustomResponse();
            }

            AdicionarErroProcessamento("Usúario ou Senha incorretos");
            return CustomResponse();
        }
